...
describe('function "get all artists"', () => {
    ...
    it('should return a new array, not update the original one', () => {
        expect(getAllArtists(songs)).not.toStrictEqual(songs);
    });
    ...
    it('should return a new array with the same length as the original one', () => {
        ...
        expect(getAllArtists(testArr)).toStrictEqual([
            'The Ramones',
            'Sublime'
        ]);
    });
...
describe('function "getSongsFromArtist"', () => {
    ...
    it('should return a new array, not update the original one', () => {
        expect(getSongsFromArtist(songs)).not.to.equal(songs);
    });
    ...
    it('should return a new array with the songs from artist', () => {
        ...
        expect(getSongsFromArtist(testArr, 'Jamiroquai')).toStrictEqual([
            {
                title: "When You Gonna Learn?",
                year: 1993,
                artist: "Jamiroquai",
...
describe('function "orderAlphabetically"', () => {
    ...
    it('should return a new array, not update the original one', () => {
        ...
        expect(arr[0].title).to.equal('xyz')
    });
    ...
    it('should order them alphabetically.', () => {
        ...
        expect(orderAlphabetically(arr)).toStrictEqual([
          'aaa',
          'aab',
          'abb',
          'abc',
...
describe('function "orderByYear"', () => {
    ...
    it('should return the element in a single element array', () => {
        expect(orderByYear([{ title: 'abc', year: 1984 }])).toStrictEqual([{ title: 'abc', year: 1984 }]);
    });
    it('should return the new array in ascending order', () => {
        expect(orderByYear([{ title: 'abc', year: 2000 }, { title: 'bac', year: 1975 }, { title: 'aab', year: 1984 }])).toStrictEqual([{ title: 'bac', year: 1975 }, { title: 'aab', year: 1984 }, { title: 'abc', year: 2000 }]);
    });
...
describe('function "songsByGenre"', () => {
    ...
    it('should return a new array, not update the original one', () => {
        expect(songsByGenre(songs)).not.to.equal(songs);
    });
    it('should return a new array with the songs with the genre asked', () => {
        ...
        expect(songsByGenre(arr, 'Jazz')).toStrictEqual([
            {
                title: "Hell",
                year: 1996,
                artist: "Squirrel Nut Zippers",
...
describe('function "minutsToSeconds"', () => {
    ...
    it('should return a new array, not update the original one', () => {
        expect(minutsToSeconds(songs)).not.to.equal(songs);
    });
...
describe('function "getLongestSong"', () => {
    ...
    it('should return a new array, not update the original one', () => {
        expect(getLongestSong(songs)).not.to.equal(songs);
    });
    //Bug in review
    ...
    it('should return an array of songs with the longest song', () => {
        ...
        expect(getLongestSong(arr)).toStrictEqual([
